...
# multiple query generation prompt

query_prompt_multiple = [
    SystemMessage(
    ...
    HumanMessage(
        content="""Generate two queries which are satisfied by the text.
        Each query should be as short as possible.
        Each query should not be overly specific to the text.
        Each query is equally likely to be a question or a sentence.
...
prompt = query_prompt_multiple
prompt_used = "query_prompt_multiple"
...
with open('direct_multiple_{}.txt'.format(prompt_used), 'w') as f:
